import { Flex, Img, Text, IconButton, Tooltip } from '@chakra-ui/react';
            ...
            >
              ...
              >
                <Img
                  ...
                  cursor="pointer" // Make it clear that this is hoverable
                />
              </Tooltip>
              <Flex flexDirection={'column'} mt={2} align={'center'} justify={'center'} alignItems={'center'}>
                <Text fontWeight={'600'} fontSize={'22px'}>
                  {product.name}
                </Text>
                {/* Tooltip applied to the description */}
                <Tooltip 
                  ...
                  hasArrow
                >
                  <Text color={'gray.700'} fontWeight={'500'} fontSize={'14px'} cursor="pointer">
